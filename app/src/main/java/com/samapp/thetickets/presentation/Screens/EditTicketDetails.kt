...
import com.samapp.thetickets.utils.millisToLocalDate
import kotlinx.coroutines.flow.collectLatest
import java.time.LocalDate

@Composable
fun EditTicketDetails(
    ticketId: Int,
    ...
    var priority by remember { mutableStateOf(ticket?.ticketPriority?: Priority.MEDIUM) }
    var selectedDate by remember { mutableStateOf<LocalDate?>(ticket?.dueDate?.let {
        millisToLocalDate(
            it
        )
    }
